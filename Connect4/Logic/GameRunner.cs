...
namespace Ex05.Logic
{
    public class GameRunner
    {
        ...
        public void StartNewGame(GameConfig i_GameConfig)
        {
            ...
            m_Board = new Board(i_GameConfig.Rows, i_GameConfig.Cols);
        ...
        public ePlayerIndex CurrentPlayer
        {
        ...
        {
            get { return m_GameConfig.Player2Type; }
        }
        ...
        public ePlayerIndex LastWinner
        {
        ...
        public int GenerateComputerMove()
        {
            ...
            if (availableCount > 0)
            {
                chosenColumn = availableColumns[r_Random.Next(availableCount)];
            }
